...
exports.tblProducts = (0, pg_core_1.pgTable)('products', {
    ...
    categoryID: (0, pg_core_1.serial)('category_id')
        .references(() => exports.tblCategories.id)
        .notNull(),
    brandID: (0, pg_core_1.serial)('brand_id').references(() => exports.tblBrands.id)
});
exports.tblSpecification = (0, pg_core_1.pgTable)('specifications', {
    id: (0, pg_core_1.serial)('id').primaryKey().unique(),
    productID: (0, pg_core_1.serial)('product_id').references(() => exports.tblProducts.id),
...
exports.tblCommentProduct = (0, pg_core_1.pgTable)('comments', {
    id: (0, pg_core_1.serial)('id').primaryKey(),
    productID: (0, pg_core_1.serial)('product_id').references(() => exports.tblProducts.id),
    userID: (0, pg_core_2.uuid)('user_id').references(() => user_schema_1.tblUser.id),
